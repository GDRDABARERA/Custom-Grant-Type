...
/**
 * Grant Type handler for Grant Type refresh_token_essential which is used to get a new access token.
 */
public class EssentialRefreshGrantHandler extends AbstractAuthorizationGrantHandler {
    ...
    public OAuth2AccessTokenRespDTO issue(OAuthTokenReqMessageContext tokReqMsgCtx)
    	...
    	log.debug("in EssentialRefreshGrantHandler issue method ");
    	
    	log.debug("Before issue the token : tokReqMsgCtx.getAuthorizedUser().getUserName()="+tokReqMsgCtx.getAuthorizedUser().getUserName());
    ...
    public boolean authorizeAccessDelegation(OAuthTokenReqMessageContext tokReqMsgCtx)
    	...
    	log.debug("in EssentialRefreshGrantHandler authorizeAccessDelegation method ");
        ...
        log.debug("in EssentialRefreshGrantHandler authorizeAccessDelegation method 1");
        ...
        */
        ...
        log.debug("tokReqMsgCtx.getOauth2AccessTokenReqDTO().getGrantType()"+tokReqMsgCtx.getOauth2AccessTokenReqDTO().getGrantType());
        authzCallback.setGrantType("refresh_token_essential");
        
        log.debug("authzCallback.getGrantType()"+authzCallback.getGrantType());
        
        callbackManager.handleCallback(authzCallback);
        tokReqMsgCtx.setValidityPeriod(authzCallback.getValidityPeriod());
        
        log.debug("in EssentialRefreshGrantHandler authorizeAccessDelegation method 2 "+authzCallback.isAuthorized()+" flag");
